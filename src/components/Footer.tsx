...
// lucide-react v1 removeu os ícones de marca (GitHub, LinkedIn, etc.),
// então esses dois ficam como SVGs próprios, no mesmo tamanho do Mail.
      ...
      <div className="mx-auto max-w-content">
        <div className="flex flex-col gap-8 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex gap-4 md:gap-6">
            <a
              href="mailto:thalissondouglas86@email.com"
              aria-label="Enviar email"
              className="rounded-full p-2 text-zinc-400 transition-all duration-300 hover:-translate-y-1 hover:bg-emerald-400/10 hover:text-emerald-400 md:p-3"
            >
              <Mail className="h-5 w-5" />
            </a>
            <a
              href="https://github.com/Thspli"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/thalisson-douglas-23273b31b/"
              target="_blank"
              rel="noopener noreferrer"
